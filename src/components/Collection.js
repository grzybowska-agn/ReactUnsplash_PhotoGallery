...
class Collection extends Component {
  ...
  componentDidMount() {
    const { id, perPage, route } = this.props
    const { currentCollection, fetchCollection } = this.props.store
  ...
  renderPhotos() {
    ...
    const { currentCollection } = this.props.store
    const { sortOptions } = this.state
    const sort = sortOptions.find(item => item.active === true).value
  ...
  onSort(item) {
    const { id } = this.props
    const { sortOptions } = this.state
    const { fetchCollection, currentCollection } = this.props.store
  ...
  render() {
    const { name, id, route } = this.props
    const { isFetching } = this.props.store
